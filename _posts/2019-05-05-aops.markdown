---
layout: post
title: "AOps - Web Operations Management with Logistics tracking and User mangement"
hidden: true
visible: 0
---

AOps is a web platform to manage the operations of an organization. It allows user permission management, logistics live tracking and updation and custom job entry.
<br>
_Proprietary Project_
